...
$(document).ready(function () {
  ...
  $('#country').on('change', function () {
    ...
    var nameElement = $(this).prop('name');

    var data = _defineProperty({}, nameElement, countryId);
    ...
    $('#region').on('change', function () {
      ...
      var data = _defineProperty({}, nameElement, cityId);
...
module.exports = __webpack_require__(/*! D:\OSPanel\domains\photomodel.loc\resources\js\test.js */"./resources/js/test.js");
